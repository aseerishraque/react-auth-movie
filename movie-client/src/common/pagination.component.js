        ...
        return (
            <nav aria-label="Page navigation example d-flex flex-wrap">
                <ul className="pagination">
                    ...
                    >
                        <a href="#1" className="page-link" style={{cursor: 'pointer'}}>Previous</a>
                    </li>
                    {pages.map(page => (
                        <li 
                        ...
                        >
                            <a href="#1" className="page-link" style={{cursor: 'pointer'}}>{page}</a>
                        </li>)
                    )}
                    <li 
                        className="page-item"
                    ...
                    >
                        <a href="#1" className="page-link" style={{cursor: 'pointer'}}>Next</a>
                    </li>
                </ul>
            </nav>
        );
